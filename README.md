...
カテゴリ別の引用付き解説は [docs/bottleneck-types.md](docs/bottleneck-types.md) を参照。引用付きの一次情報 URL は **[docs/primary-sources.md](docs/primary-sources.md)** に Tier 別 (Tier 1: V8 公式 + ECMA-262 / Tier 2: V8 team member / Tier 3: 信頼性ある二次 / Tier 4: 理論) で集約しています。
